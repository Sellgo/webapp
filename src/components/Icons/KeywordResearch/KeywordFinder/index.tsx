...
const KeywordFinderIcon: React.FC<Props> = props => {
  const { fill } = props;
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="22.226" viewBox="0 0 25 22.226">
      <path
        fill={fill || '#fff'}
...
export default KeywordFinderIcon;
