...
class TimeLine extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      //nowposition is the reference position, this variable support the infinit
      // scrolling by accumulatning scroll times and redefining the 0 position
  ...
  calculateVerticalScrollVariables = size => {
    /* The pixel to scroll verically is equal to the pecentage of what
       the viewport represent in the context multiply by the context width */
  ...
  onSelectItem = item => {
    console.log('341', item, this.props.onSelectItem);
