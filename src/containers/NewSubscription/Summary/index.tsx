    ...
    if (discountedPrice !== originalPrice) {
      ...
      return (
        <div className={styles.priceInformation}>
          ...
          <p className={`${styles.strikeThrough} ${styles.price}`}>
            ${originalPrice}
          </p>
          <p className={styles.price}>
            ${formatDecimal(discountedPrice)}
          </p>
          <p className={styles.priceDesc}>
            Then 

            {/* If promo code duration only lasts for one payment, don't show discounted price for recurring payments */}
      ...
      return (
        <div className={styles.priceInformation}>
          ...
          <p className={styles.priceDesc}> 
            Then 
            <span className={styles.bold}>&nbsp;${originalPrice}&nbsp;</span>
            next {paymentMode} and every {paymentMode} after that. </p>
        </div>);
    }
  };
