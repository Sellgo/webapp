...
export class SignUp extends React.Component<any,State> {
  ...
  message={ id:1,title:"Account Succesfuly Created",message:"Thank you for registering", description:"You have successfully create new account with Sellgo account.", description2:"Please check your email to verify.", to:"/login", button_text:"Ok"};
