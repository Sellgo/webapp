...
const mapStateToProps = (state: any) => {
  return {
    synthesisFileID: state.synthesis.synthesisFileID,
    time_efficiency_data: state.synthesis.time_efficiency_data,
    products: state.synthesis.products,
    supplier: supplierSelector(state),
    products_track_data: state.synthesis.products_track_data,
    chart_values_price: state.synthesis.chart_values_price,
    chart_values_rank: state.synthesis.chart_values_rank,
    product_detail: state.synthesis.product_detail,
    productTrackGroup: state.synthesis.productTrackGroup,
    product_detail_chart_values_rank: state.synthesis.product_detail_chart_values_rank,
    product_detail_chart_values_price: state.synthesis.product_detail_chart_values_price,
    product_detail_chart_values_kpi: state.synthesis.product_detail_chart_values_kpi,
