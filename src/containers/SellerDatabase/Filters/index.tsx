...
/* Constants */
import { DURATIONS, FILTERS } from '../../../constants/SellerDatabase';
        ...
        <div className={styles.groupedFilters}>
          ...
          <div className={styles.filterGroups}>
            ...
            <Input
              ...
              onChange={evt => updateInputFilterValue({ ...reviewCount, min: +evt.target.value })}
            ...
            <Input
              ...
              onChange={evt => updateInputFilterValue({ ...reviewCount, max: +evt.target.value })}
          ...
          <div className={styles.filterGroups}>
            ...
            <Input
              ...
              onChange={evt => updateInputFilterValue({ ...neutralReview, min: +evt.target.value })}
            ...
            <Input
              ...
              onChange={evt => updateInputFilterValue({ ...neutralReview, max: +evt.target.value })}
