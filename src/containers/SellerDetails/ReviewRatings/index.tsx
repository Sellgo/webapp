...
import NextStars from './NextStars';
// import ProfitFinderFilterSection from '../../Synthesis/ProfitFinderFilterSection';
          ...
          <div className={styles.reviewRatingsWrapper__container}>
            <div className={styles.reviewRatingsWrapper__ratingBox}>
              ...
              <div className={styles.reviewRatingsWrapper__totalReviewBox}>
                <p className={styles.reviewRatingsWrapper__totalReviewCount}>
                  {data.total_reviews}
                </p>
