...
export const actionTypes = {
  ...
  SET_PERFECT_STOCK_GET_STARTED_JOY_RIDE_STATUS: 'SET_PERFECT_STOCK_GET_STARTED_JOY_RIDE_STATUS',
  SET_SHOW_GET_STARTED: 'SET_SHOW_GET_STARTED',
  SET_SELLGO_GET_STARTED_STATUS: 'SET_SELLGO_GET_STARTED_STATUS',
  SET_SELLGO_GET_STARTED_JOY_RIDE_STATUS: 'SET_SELLGO_GET_STARTED_JOY_RIDE_STATUS',
  SET_SHOW_SELLGO_GET_STARTED: 'SET_SHOW_SELLGO_GET_STARTED',
};
