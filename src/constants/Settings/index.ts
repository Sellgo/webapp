...
export const SETTINGS_PAGES = [
  ...
  {
    name: '3PL Manager: Storage Details & Costs',
    disabled: false,
    url: '/settings/aistock/storage-details',
    showInSellgo: false,
    showInAistock: true,
    subPages: [],
  },
  {
    name: '3PL Manager: Shipment Packing Template',
    disabled: false,
    url: '/settings/aistock/shipment-packing',
    showInSellgo: false,
    showInAistock: true,
    subPages: [],
  },
  {
    name: '3PL Manager: FBA Replenishment',
    disabled: false,
    url: '/settings/aistock/replenishment',
    showInSellgo: false,
    showInAistock: true,
    subPages: [],
  },
  {
    name: '3PL Manager: FBA Inbound Draft',
    disabled: false,
