...
export const actionTypes = {
  ...
  SET_REFERENCED_ASIN_ID: 'SET_REFERENCED_ASIN_ID',
  ...
  IS_LOADING_KEYWORD_REVERSE_AGG_SUMMARY: 'IS_LOADING_KEYWORD_REVERSE_AGG_SUMMARY',
  SET_KEYWORD_REVERSE_AGG_SUMMARY: 'SET_KEYWORD_REVERSE_AGG_SUMMARY',
